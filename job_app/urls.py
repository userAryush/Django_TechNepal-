...
from job_app.views import ApplyViewSet, JobViewSet ,home,job, company,job_detail, job_apply, company_detail,login_view_user,login_view_company,company_registration,user_registration, forgot_password,index,logout_view,user_profile
